...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    MT_C(KC_TAB), KC_A,   MT_G(KC_S), MT_S(KC_D), MT_C(KC_F), KC_G,  KC_MUTE,KC_MPRV, KC_H,    MT_C(KC_J), MT_S(KC_K), MT_G(KC_L),  LT(_CONTROL, KC_SCLN), KC_ENTER,
  ...
  [_CONTROL] = LAYOUT(                                                                                                
    ...
    KC_TRNS, KC_TRNS, KC_MS_BTN3, KC_MS_BTN2, KC_MS_BTN1, KC_PGDN,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
