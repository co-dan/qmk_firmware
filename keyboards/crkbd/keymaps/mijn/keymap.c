...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_split_3x6_3(
      ...
      KC_LSFT,   KC_Z,       KC_X,       KC_C,       KC_V, KC_B,          KC_N,        KC_M,    KC_COMM,     KC_DOT, KC_SLSH, KC_BSLS,
                       MT_G(KC_ESC), MT_G(KC_ESC), LT(_LOWER,KC_BSPC),          LT(_RAISE,KC_SPC),  MT(KC_RALT,KC_ENTER), KC_ENTER
    ),                         
  ...
  [_LOWER] = LAYOUT_split_3x6_3(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, LT(_RAISE, KC_SPC), LT(_RAISE, KC_SPC), KC_TRNS
    ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,  KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_COLN,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLD, KC_VOLU,
                             _______, LT(_LOWER,KC_DEL), LT(_LOWER,KC_DEL),             _______, _______, _______                                
 ),
