...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        QK_GESC,         KC_Q,  KC_W,  KC_E,  KC_R,    KC_T,    KC_PGUP,   KC_Y,   KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPC,
        ...
        KC_MPLY,                   KC_LALT, KC_LGUI,  LT(LOWER, KC_BSPC), KC_SPC,  LT(RAISE, KC_SPC), LT(RAISE, KC_SPC),  KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT
    ),
    [_LOWER] = LAYOUT(
